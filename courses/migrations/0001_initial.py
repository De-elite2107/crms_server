# Generated by Django 5.1.3 on 2024-11-28 23:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('lecturer', 'Lecturer'), ('student', 'Student')], default='student', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Compulsory', 'Compulsory'), ('Required', 'Required'), ('Prerequisite', 'Prerequisite')], max_length=50)),
